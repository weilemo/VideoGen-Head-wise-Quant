...
DEFAULT_MODEL_CONFIG_PATH = REPO_DIR / "configs" / "self_forcing_dmd.yaml"
DEFAULT_SELF_FORCING_CKPT = Path(
    "/mnt/users/moweile-20251213/models/huggingface/hub/"
    "models--gdhe17--Self-Forcing/snapshots/"
    "2f8b779212da279d212c22a509b66ad6552f350e/checkpoints/self_forcing_dmd.pt"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, default=str(DEFAULT_SELF_FORCING_CKPT), help="Path to the checkpoint folder")
    ...
    parser.add_argument("--method", type=str, default="selfforcing", help="Method to use for selfforcing")
