...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, default="/mnt/workspace/caipeiliang/.cache/huggingface/hub/models--zhuhz22--Causal-Forcing/snapshots/634dc0df042be8133173c3eb4d9efb5da1fba9ca/chunkwise/longvideo.pt", help="Path to the checkpoint folder")
    ...
    parser.add_argument("--method", type=str, default="causalforcing")
