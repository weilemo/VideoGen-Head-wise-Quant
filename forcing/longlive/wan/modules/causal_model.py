...
from wan.modules.longlive import longlive
...
class CausalWanSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if kv_cache is None:
            ...
            x, (current_end, local_end_index, cache_update_info) = longlive(kv_cache, q, k, v, grid_sizes, freqs, current_start, sink_recache_after_switch, meta)
...
class CausalWanAttentionBlock(nn.Module):
    ...
    def forward(
        ...
        self_attn_result = self.self_attn(
            ...
            seq_lens, grid_sizes,
            freqs, block_mask, kv_cache, current_start, cache_start, sink_recache_after_switch, meta)
