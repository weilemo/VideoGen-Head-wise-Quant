...
- `Self-Forcing` 的 `QVG INT2` baseline 已在 A100 上跑通，结果已同步回 `/data2`。
...
2. 再看 `MEMORY.md`
3. 确认 BF16 结果与日志：
   - `/data2/moweile-20251213/workspace/videoquant/HeadWiseKVQuant/slurm_logs/qvg_sf_bf16_g-24046.out`
   - `/data2/moweile-20251213/workspace/videoquant/HeadWiseKVQuant/results/selfforcing/bf16/`
4. 确认 INT2 结果与日志：
   - `/data2/moweile-20251213/workspace/videoquant/HeadWiseKVQuant/slurm_logs/qvg_sf_int2_g-24309.out`
   - `/data2/moweile-20251213/workspace/videoquant/HeadWiseKVQuant/results/selfforcing/triton-nstages-kmeans-int2_64/kc_256_vc_256_nstages_1/`
5. 再看独立库：
...
6. 如果继续实现，优先进入 `HeadWiseKVQuant` 并运行 `bash scripts/self_forcing/run_random_hwq.sh` 验证第一条真实 `R-HWQ-4h` 样例
